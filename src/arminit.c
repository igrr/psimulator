...
char * intnames[] = {
"EXTFIQ",  "BLINT",  "WEINT",  "MCINT",
 "CSINT",  "EINT1",  "EINT2",  "EINT3",
 "TC1OI",  "TC2OI",  "RTCMI",   "TINT",
"UTXINT", "URXINT", "UMSINT", "SSEOTI",
};
...
//    return ;
 ...
 switch (vector) {
    ...
    case ARMul_SWIV : /* Software Interrupt */
       fprintf(stderr,"SOFTWARE INTERRUPT at %08lx\n",temp - 8);
       state->Spsr[SVCBANK] = CPSR ;
    ...
    case ARMul_PrefetchAbortV : /* Prefetch Abort */
       fprintf(stderr,"PREFETCH ABORT at %08lx\n",temp - 8);
       state->AbortAddr = 1 ;
    ...
    case ARMul_DataAbortV : /* Data Abort */
       fprintf(stderr,"DATA ABORT at %08lx\n",temp - 8);
       state->Spsr[state->prog32Sig?ABORTBANK:SVCBANK] = CPSR ;
       SETABORT(IBIT,state->prog32Sig?ABORT32MODE:SVC26MODE) ;
       ARMul_CPSRAltered(state) ;
    ...
    case ARMul_IRQV : /* IRQ */
       {int i;
        ARMword intsr = state->io.intsr;
          fprintf(stderr,"IRQ: ");
	  for(i = 15; i >= 0; i--, intsr <<= 1)
	        fprintf(stderr, "%s ", (intsr & 0x8000) ? intnames[i] : ".");
          fprintf(stderr,"\n");
       }
